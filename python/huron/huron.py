...
print("-----")
np.savetxt('huron_urdf/opt/sol_f.csv', sol_f, delimiter=',')
np.savetxt('huron_urdf/opt/sol_x', sol_x, delimiter=',')
np.savetxt('huron_urdf/opt/sol_lam_x.csv', sol_lam_x, delimiter=',')
np.savetxt('huron_urdf/opt/sol_lam_g.csv', sol_lam_g, delimiter=',')

np.savetxt('huron_urdf/opt/p_body_opt.csv', p_body_opt, delimiter=',')
np.savetxt('huron_urdf/opt/dp_body_opt.csv', dp_body_opt, delimiter=',')
np.savetxt('huron_urdf/opt/Theta_opt.csv', Theta_opt, delimiter=',')
np.savetxt('huron_urdf/opt/Omega_opt.csv', Omega_opt, delimiter=',')
np.savetxt('huron_urdf/opt/Fl_opt.csv', Fl_opt, delimiter=',')
np.savetxt('huron_urdf/opt/Fr_opt.csv', Fr_opt, delimiter=',')

np.savetxt('huron_urdf/metadata/step_list.csv', np.array(step_list), delimiter=',')
np.savetxt('huron_urdf/metadata/contact_list.csv', np.array(contact_list), delimiter=',')
np.savetxt('huron_urdf/metadata/p_feet0.csv', p_feet0, delimiter=',')
np.savetxt('huron_urdf/metadata/p_feetf.csv', p_feetf, delimiter=',')
